...
public abstract class Results {
    ...
    public static String getDetailedResults(
        ...
        return String.join("\n", 
                ...
                TestResult.getInfo(testResultInfo));
    }
    ...
    public static void logAllResults(List<TestResult> testResultInfo, SuiteResult suiteResult){
        
        logSplitByLines(getDetailedResults(suiteResult, testResultInfo));
    }
