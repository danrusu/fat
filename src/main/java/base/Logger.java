...
import static main.java.utils.FileUtils.createDirs;
import static main.java.utils.FileUtils.getRelativePath;
import static main.java.utils.SystemUtils.getBooleanPropertyOrDefault;
...
public class Logger {   
    ...
    private static String logFolderTimeStamp;
    ...
    private Logger(){
            ...
            logFolderTimeStamp = getTimeStamp(FILE_NAME_TIMESTAMP_FORMAT); 
            logDirPath = logsRootPath.resolve("log__" + logFolderTimeStamp);        
    ...
    public static void logFormat(String format, Object ...values){
    ...
    public static String getLogFolderTimeStamp() {
        return logFolderTimeStamp;
    }
