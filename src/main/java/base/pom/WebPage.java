...
import static main.java.base.selenium.Driver.DEFAULT_IMPLICIT_MILISECOND_WAIT;
import static main.java.utils.DynamicCheck.waitUntilFunctionReturnsExpectedValue;
import static main.java.utils.DynamicCheck.waitUntilFunctionReturnsValueThatMachesRegex;
...
public class WebPage {
    ...
    public void instantClick(By by){    
        ...
        explicitWait(0).until(ExpectedConditions.elementToBeClickable(by)).click();
    }
    ...
    public boolean isElementFound(By by){
        ...
        return isElementFound(by, DEFAULT_IMPLICIT_MILISECOND_WAIT);
    }
    ...
    public String getText(By by, boolean waitForVisibility){
        return getText( by, waitForVisibility, explicitWait());        
    }
    ...
    public void setDefaultImplicitWait() {
        ...
        setImplicitWait(DEFAULT_IMPLICIT_MILISECOND_WAIT);
    }
    ...
    public static void waitForAjaxFinish(WebDriver driver, long secondsWait){
        ...
        try {
            ...
            Assert.fail("AJAX requests were not finished after " + secondsWait + "s.");
        }
    ...
    public void moveMouseOverElement(By locator){
        ...
        if (Driver.getBrowser().equals(Browser.FIREFOX)){
    ...
    public void checkUrlAndTitle(String url, String title, long timeoutInMiliSeconds) {
        ...
        if (url != null){
            Assert.isEqual(true,
                    ...
                    waitUntilFunctionReturnsExpectedValue(
        ...
        if (title != null){
            Assert.isEqual(true,
                    ...
                    waitUntilFunctionReturnsExpectedValue(timeoutInMiliSeconds,
                            500, 
    ...
    public void checkUrlByRegex(String urlRegex, long timeoutInMiliSeconds) {              

        waitUntilFunctionReturnsValueThatMachesRegex(
                timeoutInMiliSeconds,
                500, 
                this::getCurrentUrl,                 
                urlRegex);
