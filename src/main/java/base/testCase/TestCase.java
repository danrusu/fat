...
import static main.java.base.runnerConfig.TestCaseAttribute.failure;
import static main.java.base.runnerConfig.TestCaseAttribute.skip;
import static main.java.base.xmlSuite.XmlDynamicData.evaluateAttributeValue;
import static main.java.base.xmlSuite.XmlDynamicData.getSavedData;
import static main.java.base.xmlSuite.XmlDynamicData.saveData;
...
import main.java.base.AssertCondition;
...
abstract public class TestCase implements Runnable, TestCaseScenario{	
    ...
    public float evalFloatAttribute(String attribute){

        return evalFloatAttribute(attribute, 0);
    }
