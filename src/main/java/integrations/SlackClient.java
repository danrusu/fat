...
public class SlackClient {
	...
	private SlackClient(SlackClientBuilder slackApiBuilder) {
	...
	public static class SlackClientBuilder {
		...
		public SlackClientBuilder(String url) {
			this.url = url;
			this.text = "";
			this.username = "";
			this.channel = "";
		...
		public SlackClientBuilder text(String text) {
			this.text += text;
			return this;
		}

		public SlackClientBuilder link(String url, String text) {
			this.text += "<" + url + " | " + text + ">";
			return this;
		}

		public SlackClientBuilder textLine(String text) {
			this.text += "\n" + text;
			return this;
		}

		public SlackClientBuilder username(String username) {
			this.username = username;
			return this;
		}

		public SlackClientBuilder channel(String channel) {
	...
	public void post() {
		...
		softlyAssertAll(
				() -> Assert.isEqual(200, response.statusCode(), "SLACK_CLIENT_RESPONSE_CODE"),
				() -> Assert.isEqual("ok", response.body().asString(), "SLACK_CLIENT_RESPONSE_BODY"));		 		 
	}
		...
		try {
			...
			softlyAssertAll(
					...
					() -> Assert.isEqual(200, 
							...
							"SLACK_CLIENT_RESPONSE_CODE"),
					
					() -> Assert.isEqual("ok", 
							body, 
							"SLACK_CLIENT_RESPONSE_REASON"));
